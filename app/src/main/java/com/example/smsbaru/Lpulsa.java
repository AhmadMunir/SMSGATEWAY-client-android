...
public class Lpulsa extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lpulsa);
        ...
        listView =(ListView) findViewById(R.id.laporan_pulsa);
        records = new ArrayList<String>();
        adapter = new Pulsaadapter(this, R.layout.list_pulsa, R.id.id, records);
    ...
    public void readData(){
        ...
        String sql = "SELECT * FROM tbl_sms WHERE jenis='Pulsa' ORDER BY id DESC";
    ...
    public void actpulsa(View view) {
        Intent intent = new Intent(Lpulsa.this ,MainActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Lpulsa.this, Home.class);
        startActivity(intent);
        finish();
    }
}
